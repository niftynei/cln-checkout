module github.com/niftynei/cln-checkout/example

go 1.21.6

require github.com/niftynei/cln-checkout/checkout v0.0.0-20241208001254-e8a6d6de2227
...
require (
	...
	github.com/niftynei/cln-checkout/cln v0.0.0-20241208001254-e8a6d6de2227 // indirect
