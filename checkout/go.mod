...
require github.com/base58btc/clnsocket v0.0.0-00010101000000-000000000000
...
replace github.com/jb55/lnsocket/go => github.com/niftynei/lnsocket/go v0.0.0-20230517173613-b7d9bce6c787

replace github.com/base58btc/clnsocket => ../cln
